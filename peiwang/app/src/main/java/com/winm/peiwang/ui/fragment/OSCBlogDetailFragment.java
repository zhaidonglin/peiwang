...
import com.winm.peiwang.domain.OSCBlogEntity;
...
public class OSCBlogDetailFragment extends TitleBarFragment {
    ...
    @BindView(id = com.winm.peiwang.R.id.blogdetail_webview)
    private WebView mWebView;
    @BindView(id = com.winm.peiwang.R.id.blogdetail_tv_author)
    private TextView mTvAuthor;
    @BindView(id = com.winm.peiwang.R.id.blogdetail_tv_time)
    private TextView mTvTime;
    @BindView(id = com.winm.peiwang.R.id.blogdetail_tv_title)
    ...
    protected View inflaterView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = View.inflate(aty, com.winm.peiwang.R.layout.frag_blog_detail, null);
        return root;
    }
    ...
    protected void setActionBarRes(ActionBarRes actionBarRes) {
        ...
        actionBarRes.title = getString(com.winm.peiwang.R.string.blog_detail);
        ...
        if (datas != null && datas.size() != 0) {
            actionBarRes.menuImageId = com.winm.peiwang.R.drawable.titlebar_star;
            outsideAty.mImgMenu.setTag(Boolean.valueOf(true));
        } else {
            actionBarRes.menuImageId = com.winm.peiwang.R.drawable.titlebar_unstar;
    ...
    public void onMenuClick() {
        ...
        if (tag != null && tag instanceof Boolean) {
            if ((Boolean) tag) {
                outsideAty.mImgMenu.setTag(Boolean.valueOf(false));
                setMenuImage(com.winm.peiwang.R.drawable.titlebar_unstar);
        ...
        outsideAty.mImgMenu.setTag(Boolean.valueOf(true));
        setMenuImage(com.winm.peiwang.R.drawable.titlebar_star);
