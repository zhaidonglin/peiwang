...
public class MineFragment extends TitleBarFragment {
    ...
    @BindView(id = com.winm.peiwang.R.id.mine_tv_collect, click = true)
    private TextView mTvCollect;
    @BindView(id = com.winm.peiwang.R.id.mine_tv_join, click = true)
    private TextView mTvJoin;
    @BindView(id = com.winm.peiwang.R.id.mine_tv_other, click = true)
    private TextView mTvOther;
    @BindView(id = com.winm.peiwang.R.id.mine_rl_feedback, click = true)
    private RelativeLayout mRlFeedback;
    @BindView(id = com.winm.peiwang.R.id.mine_rl_about, click = true)
    private RelativeLayout mRlAbout;
    @BindView(id = com.winm.peiwang.R.id.mine_rl_push, click = true)
    private RelativeLayout mRlPush;
    @BindView(id = com.winm.peiwang.R.id.mine_rl_clean, click = true)
    private RelativeLayout mRlClean;
    @BindView(id = com.winm.peiwang.R.id.mine_rl_exit, click = true)
    private RelativeLayout mRlExit;
    @BindView(id = com.winm.peiwang.R.id.mine_tv_currentversion)
    private TextView mTvVersion;
    @BindView(id = com.winm.peiwang.R.id.mine_cbox_push)
    ...
    protected View inflaterView(LayoutInflater inflater, ViewGroup container,
            Bundle bundle) {
        View view = View.inflate(outsideAty, com.winm.peiwang.R.layout.frag_mine, null);
        return view;
    }
    ...
    protected void widgetClick(View v) {
        ...
        case com.winm.peiwang.R.id.mine_rl_clean:
            ...
            break;
        case com.winm.peiwang.R.id.mine_rl_feedback:
            doJoin("http://jq.qq.com/?_wv=1027&k=XblWhv");
            break;
        case com.winm.peiwang.R.id.mine_rl_exit:
            break;
        default:
            break;
        }
