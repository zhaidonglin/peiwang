...
public class Splash extends KJActivity {
    ...
    @BindView(id = com.winm.peiwang.R.id.splash_layout_root)
    private RelativeLayout mRlRoot;
    @BindView(id = com.winm.peiwang.R.id.splash_box)
    private RelativeLayout mRlBox;
    @BindView(id = com.winm.peiwang.R.id.splash_tv_content)
    private TextView mTvContent;
    @BindView(id = com.winm.peiwang.R.id.splash_img_head)
    private RoundImageView mImgHead;
    @BindView(id = com.winm.peiwang.R.id.splash_btn_go, click = true)
    private Button mBtnGo;

    @Override
    public void setRootView() {
        setContentView(com.winm.peiwang.R.layout.aty_splash);
    }
    ...
    private void screenAdaptation() {
        ...
        goParams.height = (int) getResources().getDimension(
                com.winm.peiwang.R.dimen.splash_btn_go_height);
    ...
    public void widgetClick(View v) {
        super.widgetClick(v);
        switch (v.getId()) {
        case com.winm.peiwang.R.id.splash_btn_go:
    ...
    private void setUserInterface() {
        ...
        String contentStr = PreferenceHelper.readString(aty, TAG,
                ...
                getString(com.winm.peiwang.R.string.splash_content));
