...
import com.winm.peiwang.adapter.BlogAuthorAdapter;
...
public class BlogAuthorFragment extends TitleBarFragment {
    ...
    protected View inflaterView(LayoutInflater inflater, ViewGroup container,
            Bundle bundle) {
        View rootView = inflater.inflate(com.winm.peiwang.R.layout.frag_pull_refresh_listview,
                container, false);
        return rootView;
    }
    ...
    protected void setActionBarRes(ActionBarRes actionBarRes) {
        ...
        actionBarRes.title = getString(com.winm.peiwang.R.string.str_follow);
        ...
        if (!StringUtils.isEmpty(cache)) {
            ...
            if (adapter == null) {
                adapter = new BlogAuthorAdapter(mListView, datas,
                        com.winm.peiwang.R.layout.item_blog_author);
