...
public class AppStart extends KJActivity {
    ...
    public void setRootView() {
        ...
        image.setImageResource(com.winm.peiwang.R.drawable.splash_bg);
        Animation anim = AnimationUtils.loadAnimation(aty, com.winm.peiwang.R.anim.splash_start);
...
//        if (!isFirst) {
            jumpIntent.setClass(aty, Login.class);
//        } else {
