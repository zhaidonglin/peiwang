...
import com.winm.peiwang.domain.NotebookData;
import com.winm.peiwang.ui.fragment.NoteEditFragment;
import com.winm.peiwang.ui.widget.KJDragGridView;
...
public class NotebookAdapter extends BaseAdapter implements KJDragGridView.DragGridBaseAdapter {
    ...
    public NotebookAdapter(Activity aty, List<NotebookData> datas) {
        ...
        height = (int) aty.getResources().getDimension(com.winm.peiwang.R.dimen.space_35);
    }
    ...
    public View getView(int position, View v, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = View.inflate(aty, com.winm.peiwang.R.layout.item_notebook, null);
            holder.titleBar = v.findViewById(com.winm.peiwang.R.id.item_note_titlebar);
            holder.date = (TextView) v.findViewById(com.winm.peiwang.R.id.item_note_tv_date);
            holder.state = (ImageView) v.findViewById(com.winm.peiwang.R.id.item_note_img_state);
            holder.thumbtack = (ImageView) v
                    .findViewById(com.winm.peiwang.R.id.item_note_img_thumbtack);
            holder.content = (TextView) v.findViewById(com.winm.peiwang.R.id.item_note_content);
            v.setTag(holder);
        } else {
