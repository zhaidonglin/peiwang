...
import com.winm.peiwang.adapter.ActiveAdapter;
import com.winm.peiwang.domain.ActiveList;
import com.winm.peiwang.ui.Browser;
...
import com.winm.peiwang.ui.widget.listview.PullToRefreshBase.OnRefreshListener;
...
public class ActiveFragment extends TitleBarFragment implements
    ...
    protected void setActionBarRes(ActionBarRes actionBarRes) {
        ...
        actionBarRes.title = getString(com.winm.peiwang.R.string.str_active_title);
        ...
        if (!StringUtils.isEmpty(cache)) {
            ...
            if (adapter == null) {
                adapter = new ActiveAdapter(mListView, dataRes.getEvents(),
                        com.winm.peiwang.R.layout.item_list_active);
                ...
                if (t != null && !t.equals(cache)) {
                    ...
                    if (adapter == null) {
                        adapter = new ActiveAdapter(mListView, dataRes
                                .getEvents(), com.winm.peiwang.R.layout.item_list_active);
                        mListView.setAdapter(adapter);
                    } else {
                        adapter.refresh(dataRes.getEvents());
                    }
