 ...
 */
package com.winm.peiwang.ui.widget;

import java.io.File;
import java.lang.ref.WeakReference;

import com.winm.peiwang.ui.widget.RecordButtonUtil.OnPlayListener;
...
public class RecordButton extends RelativeLayout {
    ...
    private void init() {
        ...
        initSavePath();
        LayoutInflater.from(getContext()).inflate(com.winm.peiwang.R.layout.record_view, this);
        mImgDelete = (ImageView) findViewById(com.winm.peiwang.R.id.recordview_delete);
        mImgListen = (ImageView) findViewById(com.winm.peiwang.R.id.recordview_listen);
        mImgPlay = (ImageView) findViewById(com.winm.peiwang.R.id.recordview_start);
        bottomFlag = findViewById(com.winm.peiwang.R.id.recordview_text);
        topFlag = findViewById(com.winm.peiwang.R.id.recordview_layout);
        mTvRecordTime = (TextView) findViewById(com.winm.peiwang.R.id.recordview_text_time);
        mImgVolume = (ImageView) findViewById(com.winm.peiwang.R.id.recordview_img_volume);
        initPlayButtonEvent();
    }
    ...
    private void changeVolume(int volume) {
        ...
        case 1:
        case 2:
            mImgVolume.setImageResource(com.winm.peiwang.R.drawable.audio0);
            break;
        case 3:
            mImgVolume.setImageResource(com.winm.peiwang.R.drawable.audio1);
            break;
        case 4:
            mImgVolume.setImageResource(com.winm.peiwang.R.drawable.audio2);
            break;
        case 5:
            mImgVolume.setImageResource(com.winm.peiwang.R.drawable.audio3);
            break;
        }
    }
