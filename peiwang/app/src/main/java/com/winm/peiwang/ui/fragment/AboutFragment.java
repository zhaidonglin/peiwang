...
public class AboutFragment extends TitleBarFragment {
    ...
    @BindView(id = com.winm.peiwang.R.id.use_help, click = true)
    private RelativeLayout mRlHelp;
    @BindView(id = com.winm.peiwang.R.id.version, click = true)
    private RelativeLayout mRlVersion;
    @BindView(id = com.winm.peiwang.R.id.about_me, click = true)
    private RelativeLayout mRlAuthor;
    @BindView(id = com.winm.peiwang.R.id.root)
    ...
    protected View inflaterView(LayoutInflater inflater, ViewGroup container,
            Bundle bundle) {
        View view = View.inflate(outsideAty, com.winm.peiwang.R.layout.frag_about, null);
        return view;
    }

    @Override
    protected void setActionBarRes(ActionBarRes actionBarRes) {
        actionBarRes.title = getString(com.winm.peiwang.R.string.about);
    }
    ...
    protected void widgetClick(View v) {
        super.widgetClick(v);
        switch (v.getId()) {
        case com.winm.peiwang.R.id.use_help:
            UIHelper.toBrowser(outsideAty, "http://www.kymjs.com");
            break;
        case com.winm.peiwang.R.id.version:
            update();
            break;
        case com.winm.peiwang.R.id.about_me:
            UIHelper.toBrowser(outsideAty, "http://peiwang.kymjs.com/about/");
            break;
