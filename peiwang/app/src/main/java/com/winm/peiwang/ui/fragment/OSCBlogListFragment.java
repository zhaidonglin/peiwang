...
import com.winm.peiwang.adapter.OSCBlogAdapter;
import com.winm.peiwang.domain.OSCBlog;
import com.winm.peiwang.domain.OSCBlogList;
...
import com.winm.peiwang.ui.widget.listview.FooterLoadingLayout;
...
import com.winm.peiwang.ui.widget.listview.ILoadingLayout;
...
public class OSCBlogListFragment extends TitleBarFragment {
    ...
    protected void initData() {
        ...
        if (StringUtils.isEmpty(name)) {
            titleBarName = getString(com.winm.peiwang.R.string.osc_joke);
        } else {
        ...
        if (!StringUtils.isEmpty(cache)) {
            ...
            if (adapter == null) {
                adapter = new OSCBlogAdapter(mListView, mDatas,
                        com.winm.peiwang.R.layout.item_list_blog);
        ...
        kjh.get(OSCBLOG_HOST + BLOGLIST_ID + OSCBLOG_INDEX + index,
                new HttpCallBack() {
                    ...
                    public void onFinish() {
                        ...
                        if (mRefreshLayout.getFooterLoadingLayout().getState() != ILoadingLayout.State.NO_MORE_DATA) {
