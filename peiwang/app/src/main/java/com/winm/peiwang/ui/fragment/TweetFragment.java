...
import com.winm.peiwang.adapter.TweetAdapter;
import com.winm.peiwang.domain.SimpleBackPage;
import com.winm.peiwang.domain.Tweet;
import com.winm.peiwang.domain.TweetsList;
...
public class TweetFragment extends TitleBarFragment {
    ...
    protected void setActionBarRes(ActionBarRes actionBarRes) {
        ...
        actionBarRes.title = getString(com.winm.peiwang.R.string.str_tweet_title);
            ...
            public void onSuccess(String t) {
                ...
                if (adapter == null) {
                    adapter = new TweetAdapter(mListView, tweets,
                            com.winm.peiwang.R.layout.item_list_tweet);
