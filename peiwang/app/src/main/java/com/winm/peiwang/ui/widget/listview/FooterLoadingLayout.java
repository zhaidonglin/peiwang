 ...
 */
package com.winm.peiwang.ui.widget.listview;
...
public class FooterLoadingLayout extends LoadingLayout {
    ...
    private void init(Context context) {
        mProgressBar = (ProgressBar) findViewById(com.winm.peiwang.R.id.pull_to_load_footer_progressbar);
        mHintView = (TextView) findViewById(com.winm.peiwang.R.id.pull_to_load_footer_hint_textview);
        setState(State.RESET);
        strNoMoreData = context.getString(com.winm.peiwang.R.string.pushmsg_center_no_more_msg);
        strRefreshing = context
                .getString(com.winm.peiwang.R.string.pull_to_refresh_header_hint_loading);
        strReleaseToRefresh = context
                .getString(com.winm.peiwang.R.string.pull_to_refresh_header_hint_ready);
        strPullToRefresh = context
                .getString(com.winm.peiwang.R.string.pull_to_refresh_header_hint_normal2);
    }

    @Override
    protected View createLoadingView(Context context, AttributeSet attrs) {
        View container = View.inflate(context, com.winm.peiwang.R.layout.pull_to_load_footer,
                null);
        return container;
    }
    ...
    public int getContentSize() {
        View view = findViewById(com.winm.peiwang.R.id.pull_to_load_footer_content);
        if (null != view) {
