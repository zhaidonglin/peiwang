...
public class MyBlogBrowser extends TitleBarActivity {
    ...
    @BindView(id = com.winm.peiwang.R.id.webview)
    WebView mWebView;
    @BindView(id = com.winm.peiwang.R.id.progress)
    ...
    public static final String DEFAULT = "http://peiwang.kymjs.com/";
    ...
    public void setRootView() {
        setContentView(com.winm.peiwang.R.layout.aty_browser);
    }
    ...
    protected void onMenuClick() {
        ...
        if (tag != null && tag instanceof Boolean) {
            if ((Boolean) tag) {
                ...
                mImgMenu.setImageResource(com.winm.peiwang.R.drawable.titlebar_unstar);
        ...
        mImgMenu.setImageResource(com.winm.peiwang.R.drawable.titlebar_star);
    ...
    public void initData() {
        ...
        if (intent != null) {
            ...
            if (StringUtils.isEmpty(strTitle)) {
                strTitle = getString(com.winm.peiwang.R.string.app_name);
            }
        }
    ...
    public void initWidget() {
        ...
        findViewById(com.winm.peiwang.R.id.browser_bottom).setVisibility(View.GONE);
    ...
    public void widgetClick(View v) {
        super.widgetClick(v);
        switch (v.getId()) {
        case com.winm.peiwang.R.id.browser_back:
            mWebView.goBack();
            break;
        case com.winm.peiwang.R.id.browser_forward:
            mWebView.goForward();
            break;
        case com.winm.peiwang.R.id.browser_refresh:
            mWebView.loadUrl(mWebView.getUrl());
            break;
        case com.winm.peiwang.R.id.browser_system_browser:
            try {
                // 启用外部浏览器
