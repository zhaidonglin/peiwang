...
import com.winm.emoji.adapter.EmojiPagerAdapter;
import com.winm.emoji.helper.InputHelper;
import com.winm.emoji.helper.SoftKeyboardStateHelper;
import com.winm.emoji.model.KJEmojiConfig;
...
public class KJEmojiFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        mRootView = (LinearLayout) inflater.inflate(com.winm.peiwang.R.layout.frag_emoji_main,
                container, false);
    ...
    private void initWidget(View rootView) {
        // title
        mEmojiTitle = rootView.findViewById(com.winm.peiwang.R.id.emoji_title);
        mEt = (EditText) mEmojiTitle.findViewById(com.winm.peiwang.R.id.emoji_titile_input);
        mCBox = (CheckBox) mEmojiTitle.findViewById(com.winm.peiwang.R.id.emoji_title_menu);
        ...
        // bottom
        mEmojiBottom = (RadioGroup) rootView.findViewById(com.winm.peiwang.R.id.emoji_bottom);
        ...
        mEmojiBottom.findViewById(com.winm.peiwang.R.id.emoji_bottom_del).setOnClickListener(
                new OnClickListener() {
                    @Override
        ...
        mEmojiContent = (LinearLayout) rootView
                .findViewById(com.winm.peiwang.R.id.emoji_content);
        ...
        mEmojiPager = (ViewPager) mEmojiContent.findViewById(com.winm.peiwang.R.id.emoji_pager);
        ...
        if (getActivity() instanceof OnSendClickListener) {
            ...
            mEmojiTitle.findViewById(com.winm.peiwang.R.id.emoji_title_send).setOnClickListener(
                    new OnClickListener() {
                        @Override
                        public void onClick(View v) {
